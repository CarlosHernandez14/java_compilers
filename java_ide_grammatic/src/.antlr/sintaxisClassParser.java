...
public class sintaxisClassParser extends Parser {
	...
	public static final int
		...
		RULE_instruccion = 11, RULE_method_call = 12, RULE_asignacion = 13, RULE_declaracion = 14, 
		RULE_declaracion_args = 15, RULE_expresion = 16, RULE_multExp = 17, RULE_atomExp = 18, 
		RULE_comparacion = 19;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "class_", "member", "property", "metodo", "modificAcceso", 
			"tipo", "returnTypeMethods", "returnExpMethods", "control_structure", 
			"conditional", "instruccion", "method_call", "asignacion", "declaracion", 
			"declaracion_args", "expresion", "multExp", "atomExp", "comparacion"
		};
	}
	...
	public final MetodoContext metodo() throws RecognitionException {
		...
		try {
			...
			returnTypeMethods();
			setState(97);
			((MetodoContext)_localctx).name = match(ID);
			 
			                    
			                    // Guardamos el nombre actual
			                    currentMethodName = (((MetodoContext)_localctx).name!=null?((MetodoContext)_localctx).name.getText():null);

			                    // Push global y registro en methodCalls
			                    pushTSGlobal(currentMethodName, SymbolType.METHOD, ((MetodoContext)_localctx).name);
			                    if (methodCalls.containsKey(currentMethodName)) {
			                        errorListener.addSemanticError(
			                            "El método '" + currentMethodName + "' ya ha sido declarado",
			                            ((MetodoContext)_localctx).name.getLine(),
			                            ((MetodoContext)_localctx).name.getCharPositionInLine()
			                        );
			                    } else {
	...
	public static class Method_callContext extends ParserRuleContext {
		public Token ID;
		public ExpresionContext expresion;
		public List<ExpresionContext> exprs = new ArrayList<ExpresionContext>();
		public TerminalNode ID() { return getToken(sintaxisClassParser.ID, 0); }
		public TerminalNode SEMICOLON() { return getToken(sintaxisClassParser.SEMICOLON, 0); }
		public List<ExpresionContext> expresion() {
			return getRuleContexts(ExpresionContext.class);
	...
	public final Method_callContext method_call() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 30064771136L) != 0)) {
				{
				setState(161);
				((Method_callContext)_localctx).expresion = expresion();
				((Method_callContext)_localctx).exprs.add(((Method_callContext)_localctx).expresion);
				}
			}
			...
			match(SEMICOLON);
			                    ...
			                    if (!TSGlobal.containsKey((((Method_callContext)_localctx).ID!=null?((Method_callContext)_localctx).ID.getText():null)) && TSGlobal.get((((Method_callContext)_localctx).ID!=null?((Method_callContext)_localctx).ID.getText():null)) != SymbolType.METHOD.ordinal()) {
			                        // System.out.println("Error: El metodo " + (((Method_callContext)_localctx).ID!=null?((Method_callContext)_localctx).ID.getText():null) + " no ha sido declarado");
			                        // Agregamos el error de semantica al errorListener
			                        errorListener.addSemanticError(
			                            "El metodo '" + (((Method_callContext)_localctx).ID!=null?((Method_callContext)_localctx).ID.getText():null) + "' no ha sido declarado",
			                            ((Method_callContext)_localctx).ID.getLine(),
			                            ((Method_callContext)_localctx).ID.getCharPositionInLine()
			                        );
			                    } else {
			                        // Verificar si el metodo tiene los mismos argumentos que la llamada
			                        if (methodCalls.containsKey((((Method_callContext)_localctx).ID!=null?((Method_callContext)_localctx).ID.getText():null))) {
			                            MethodCallInfo methodCallInfo = methodCalls.get((((Method_callContext)_localctx).ID!=null?((Method_callContext)_localctx).ID.getText():null));
			                            if (methodCallInfo.args.size() != ((Method_callContext)_localctx).exprs.size()) {
			                                // System.out.println("Error: El metodo " + (((Method_callContext)_localctx).ID!=null?((Method_callContext)_localctx).ID.getText():null) + " no tiene el mismo numero de argumentos que la llamada");
			                                // Agregamos el error de semantica al errorListener
			                                errorListener.addSemanticError(
			                                    "El metodo '" + (((Method_callContext)_localctx).ID!=null?((Method_callContext)_localctx).ID.getText():null) + "' no tiene el mismo numero de argumentos que la llamada",
			                                    ((Method_callContext)_localctx).ID.getLine(),
			                                    ((Method_callContext)_localctx).ID.getCharPositionInLine()
			                                );
			                            } else {
			                                for (int i = 0; i < methodCallInfo.args.size(); i++) {
			                                    if (methodCallInfo.args.get(i) != ((Method_callContext)_localctx).exprs.get(i).returnType) {
			                                        // System.out.println("Error: El tipo de argumento " + i + " no coincide con el tipo del metodo " + (((Method_callContext)_localctx).ID!=null?((Method_callContext)_localctx).ID.getText():null));
			                                        // Agregamos el error de semantica al errorListener
			                                        errorListener.addSemanticError(
			                                            "El tipo de argumento " + i + " no coincide con el tipo del metodo '" + (((Method_callContext)_localctx).ID!=null?((Method_callContext)_localctx).ID.getText():null) + "'",
			                                            ((Method_callContext)_localctx).ID.getLine(),
			                                            ((Method_callContext)_localctx).ID.getCharPositionInLine()
			                                        );
			                                    }
			                                ...
			                                methodCalls.put((((Method_callContext)_localctx).ID!=null?((Method_callContext)_localctx).ID.getText():null), methodCallInfo);
			                            }
			                        } else {
			                            // System.out.println("Error: El metodo " + (((Method_callContext)_localctx).ID!=null?((Method_callContext)_localctx).ID.getText():null) + " no ha sido declarado");
			                            // Agregamos el error de semantica al errorListener
	...
	public final Declaracion_argsContext declaracion_args() throws RecognitionException {
		...
		enterRule(_localctx, 30, RULE_declaracion_args);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			((Declaracion_argsContext)_localctx).idArg1 = match(ID);
			                        ...
			                        info.args.add(SymbolType.valueOf((((Declaracion_argsContext)_localctx).tipo!=null?_input.getText(((Declaracion_argsContext)_localctx).tipo.start,((Declaracion_argsContext)_localctx).tipo.stop):null).toUpperCase()));
			...
			while (_la==T__4) {
				...
				((Declaracion_argsContext)_localctx).idArg2 = match(ID);
				                            ...
				                            infoCall.args.add(SymbolType.valueOf((((Declaracion_argsContext)_localctx).tipo!=null?_input.getText(((Declaracion_argsContext)_localctx).tipo.start,((Declaracion_argsContext)_localctx).tipo.stop):null).toUpperCase()));
	...
	public final MultExpContext multExp() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_multExp);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
